...
#     wp core install --title=ft_services --url=192.168.99.129:5050 --admin_user=lbisscho --admin_password=password --admin_email=lbisscho@student.codam.nl --skip-email
